    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Admin.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
            }
...
(function (Admin) {
    ...
    })(Meeting = Admin.Meeting || (Admin.Meeting = {}));
})(Admin || (Admin = {}));
var Admin;
(function (Admin) {
    var Meeting;
        ...
        var MeetingAttendeeEditor = (function (_super) {
            ...
            MeetingAttendeeEditor.prototype.createToolbarExtensions = function () {
                ...
                Serenity.Widget.create({
                    type: Serenity.LookupEditor,
                    options: {
                        lookupKey: Admin.Organization.ContactRow.lookupKey
                    },
                    ...
                    init: function (w) { return w.changeSelect2(function (x) {
                        if (Q.isEmptyOrNull(w.value))
                            return;
                        var contact = Admin.Organization.ContactRow.getLookup().itemById[Q.toId(w.value)];
                        w.value = null;
                        if (!contact)
                            return;
    ...
    (function (Default) {
        var DataBaseDialog = (function (_super) {
            ...
            function DataBaseDialog() {
                _super.apply(this, arguments);
                this.form = new Default.DataBaseForm(this.idPrefix);
            }
            DataBaseDialog.prototype.getFormKey = function () { return Default.DataBaseForm.formKey; };
            DataBaseDialog.prototype.getIdProperty = function () { return Default.DataBaseRow.idProperty; };
            DataBaseDialog.prototype.getLocalTextPrefix = function () { return Default.DataBaseRow.localTextPrefix; };
            DataBaseDialog.prototype.getNameProperty = function () { return Default.DataBaseRow.nameProperty; };
            DataBaseDialog.prototype.getService = function () { return Default.DataBaseService.baseUrl; };
        ...
        Default.DataBaseDialog = DataBaseDialog;
    })(Default = Admin.Default || (Admin.Default = {}));
})(Admin || (Admin = {}));
/// <reference path="../../Common/Helpers/GridEditorBase.ts" />
var Admin;
(function (Admin) {
    ...
    (function (Default) {
        var DataBaseEditor = (function (_super) {
            ...
            DataBaseEditor.prototype.getColumnsKey = function () { return 'Default.DataBase'; };
            DataBaseEditor.prototype.getDialogType = function () { return Default.DataBaseEditorDialog; };
            DataBaseEditor.prototype.getLocalTextPrefix = function () { return Default.DataBaseRow.localTextPrefix; };
            DataBaseEditor = __decorate([
                Serenity.Decorators.registerClass()
            ], DataBaseEditor);
            return DataBaseEditor;
        }(Admin.Common.GridEditorBase));
        Default.DataBaseEditor = DataBaseEditor;
    })(Default = Admin.Default || (Admin.Default = {}));
})(Admin || (Admin = {}));
/// <reference path="../../Common/Helpers/GridEditorDialog.ts" />
var Admin;
(function (Admin) {
    ...
    (function (Default) {
        var DataBaseEditorDialog = (function (_super) {
            ...
            DataBaseEditorDialog.prototype.getFormKey = function () { return Default.DataBaseForm.formKey; };
            DataBaseEditorDialog.prototype.getLocalTextPrefix = function () { return Default.DataBaseRow.localTextPrefix; };
            DataBaseEditorDialog.prototype.getNameProperty = function () { return Default.DataBaseRow.nameProperty; };
        ...
        Default.DataBaseEditorDialog = DataBaseEditorDialog;
    })(Default = Admin.Default || (Admin.Default = {}));
})(Admin || (Admin = {}));
var Admin;
(function (Admin) {
    ...
    (function (Default) {
        var DataBaseGrid = (function (_super) {
            ...
            DataBaseGrid.prototype.getColumnsKey = function () { return 'Default.DataBase'; };
            DataBaseGrid.prototype.getDialogType = function () { return Default.DataBaseDialog; };
            DataBaseGrid.prototype.getIdProperty = function () { return Default.DataBaseRow.idProperty; };
            DataBaseGrid.prototype.getLocalTextPrefix = function () { return Default.DataBaseRow.localTextPrefix; };
            DataBaseGrid.prototype.getService = function () { return Default.DataBaseService.baseUrl; };
            DataBaseGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], DataBaseGrid);
            return DataBaseGrid;
        }(Serenity.EntityGrid));
        Default.DataBaseGrid = DataBaseGrid;
    })(Default = Admin.Default || (Admin.Default = {}));
})(Admin || (Admin = {}));
var Admin;
(function (Admin) {
...
(function (Admin) {
    ...
    (function (Default) {
        var DataBaseForm = (function (_super) {
            ...
            DataBaseForm.formKey = 'Default.DataBase';
            return DataBaseForm;
        }(Serenity.PrefixedContext));
        Default.DataBaseForm = DataBaseForm;
...
(function (Admin) {
    ...
    (function (Default) {
        ...
        (function (DataBaseRow) {
            ...
            DataBaseRow.localTextPrefix = 'Default.DataBase';
            var Fields;
            (function (Fields) {
        ...
        })(DataBaseRow = Default.DataBaseRow || (Default.DataBaseRow = {}));
    })(Default = Admin.Default || (Admin.Default = {}));
})(Admin || (Admin = {}));
var Admin;
(function (Admin) {
    ...
    (function (Default) {
        ...
        (function (DataBaseService) {
            DataBaseService.baseUrl = 'Default/DataBase';
            var Methods;
            (function (Methods) {
        ...
        })(DataBaseService = Default.DataBaseService || (Default.DataBaseService = {}));
    })(Default = Admin.Default || (Admin.Default = {}));
})(Admin || (Admin = {}));
var Admin;
(function (Admin) {
        ...
        var TreeGrid = (function (_super) {
            ...
            function TreeGrid(container) {
                ...
                this.treeMixin = new Serenity.TreeGridMixin({
                    ...
                    toggleField: Admin.Northwind.OrderRow.Fields.CustomerCompanyName,
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = (function (_super) {
            ...
            QuickFilterCustomization.prototype.getQuickFilters = function () {
                ...
                var fld = Admin.Northwind.OrderRow.Fields;
        ...
        var CustomLinksInGrid = (function (_super) {
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Admin.Northwind.OrderRow.Fields.ShipCountry);
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Admin.Northwind.ProductRow.Fields;
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new Admin.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = Admin.Northwind.ProductRow.Fields.CategoryID;
    ...
    (function (BasicSamples) {
        ...
        var OtherFormOneBarDialog = (function (_super) {
            ...
            function OtherFormOneBarDialog() {
                ...
                this.customerForm = new Admin.Northwind.CustomerForm(this.customerPropertyGrid.idPrefix);
...
(function (Admin) {
    ...
    (function (BasicSamples) {
        ...
        [['StaticText', function () { return Admin.StaticTextBlock; }], ['SomeInput', function () { return Serenity.StringEditor; }], ['HtmlList', function () { return Admin.StaticTextBlock; }], ['FromLocalText', function () { return Admin.StaticTextBlock; }], ['DisplayFieldValue', function () { return Admin.StaticTextBlock; }]].forEach(function (x) { return Object.defineProperty(StaticTextBlockForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    })(BasicSamples = Admin.BasicSamples || (Admin.BasicSamples = {}));
})(Admin || (Admin = {}));
var Admin;
(function (Admin) {
...
(function (Admin) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Admin.Northwind.Entities.Gender');
    })(Northwind = Admin.Northwind || (Admin.Northwind = {}));
})(Admin || (Admin = {}));
var Admin;
(function (Admin) {
