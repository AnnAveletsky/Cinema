namespace Cinema.Admin
{
    ...
    {
        private static string[] databaseKeys = new[] { "Default", "Northwind","Movie" };
        ...
        private static void RunMigrations(string databaseKey)
        {
            ...
            // remove these lines if you want Cinema.Admin migrations to run on your DB.
            ...
            using (var sw = new StringWriter())
            {
                ...
                var runner = new RunnerContext(announcer)
                {
                    ...
                    Namespace = "Cinema.Admin.Migrations." + databaseKey + "DB"
                };
