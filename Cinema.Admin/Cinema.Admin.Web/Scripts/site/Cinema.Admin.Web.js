...
(function (Cinema.Admin) {
    ...
    (function (Northwind) {
        var TerritoryDialog = (function (_super) {
            ...
            TerritoryDialog.prototype.getLanguages = function () {
                return Cinema.Admin.LanguageList.getValue();
            };
    ...
    })(Northwind = Cinema.Admin.Northwind || (Cinema.Admin.Northwind = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Northwind;
    (function (Northwind) {
    ...
    (function (Northwind) {
        var ProductGrid = (function (_super) {
            ...
            ProductGrid.prototype.getButtons = function () {
                ...
                buttons.push(Cinema.Admin.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    service: Northwind.ProductService.baseUrl + '/ListExcel',
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    separator: true
                }));
                buttons.push(Cinema.Admin.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
...
(function (Cinema.Admin) {
    ...
    })(Common = Cinema.Admin.Common || (Cinema.Admin.Common = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
...
(function (Cinema.Admin) {
    ...
    (function (Northwind) {
        ...
        }(Cinema.Admin.Common.GridEditorDialog));
...
(function (Cinema.Admin) {
    ...
    (function (Northwind) {
        ...
        }(Cinema.Admin.Common.GridEditorBase));
    ...
    (function (Common) {
        var BulkServiceAction = (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Cinema.Admin.BasicProgressDialog();
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Common.BulkServiceAction));
        BasicSamples.OrderBulkAction = OrderBulkAction;
    })(BasicSamples = Cinema.Admin.BasicSamples || (Cinema.Admin.BasicSamples = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Northwind;
    (function (Northwind) {
        var OrderDialog = (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                ...
                buttons.push(Cinema.Admin.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Cinema.Admin.Authorization.userDefinition.DisplayName,
    ...
    (function (Northwind) {
        var CustomerDialog = (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Cinema.Admin.DialogUtils.pendingChangesConfirmation(this.element, function () { return _this.getSaveState() != _this.loadedState; });
...
(function (Cinema.Admin) {
    ...
    })(Membership = Cinema.Admin.Membership || (Cinema.Admin.Membership = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Membership;
...
(function (Cinema.Admin) {
    ...
    })(ScriptInitialization = Cinema.Admin.ScriptInitialization || (Cinema.Admin.ScriptInitialization = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Common;
...
(function (Cinema.Admin) {
    ...
    })(Administration = Cinema.Admin.Administration || (Cinema.Admin.Administration = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Administration;
...
(function (Cinema.Admin) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnum(Gender, 'Cinema.Admin.Northwind.Entities.Gender');
    })(Northwind = Cinema.Admin.Northwind || (Cinema.Admin.Northwind = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
...
(function (Cinema.Admin) {
    ...
    Cinema.Admin.BasicProgressDialog = BasicProgressDialog;
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var DialogUtils;
    ...
    })(DialogUtils = Cinema.Admin.DialogUtils || (Cinema.Admin.DialogUtils = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Common;
...
(function (Cinema.Admin) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Cinema.Admin.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Cinema.Admin.LanguageList || (Cinema.Admin.LanguageList = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Common;
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Cinema.Admin.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Cinema.Admin.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Cinema.Admin.Northwind.SalesByCategoryService.baseUrl; };
            /**
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.SupplierGrid));
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.ProductGrid));
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Cinema.Admin.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Cinema.Admin.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Cinema.Admin.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Cinema.Admin.Northwind.ProductService.baseUrl; };
    ...
    (function (BasicSamples) {
        var InitialValuesForQuickFilters = (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                var fld = Cinema.Admin.Northwind.OrderRow.Fields;
                ...
                Q.first(filters, function (x) { return x.field == fld.ShippingState; }).init = function (w) {
                    ...
                    w.value = Cinema.Admin.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
        ...
        }(Cinema.Admin.Northwind.OrderGrid));
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Cinema.Admin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Cinema.Admin.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Cinema.Admin.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Cinema.Admin.Northwind.OrderDialog().loadEntityAndOpenDialog({
                    ...
                    var countryFilter = this.findQuickFilter(Serenity.LookupEditor, Cinema.Admin.Northwind.OrderRow.Fields.ShipCountry);
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Cinema.Admin.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Cinema.Admin.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Cinema.Admin.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Cinema.Admin.Northwind.ProductService.baseUrl; };
            /**
            ...
            ConditionalFormattingGrid.prototype.getColumns = function () {
                var columns = _super.prototype.getColumns.call(this);
                var fld = Cinema.Admin.Northwind.ProductRow.Fields;
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.ProductDialog));
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Cinema.Admin.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.OrderDetailsEditor));
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Cinema.Admin.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Cinema.Admin.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Cinema.Admin.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Cinema.Admin.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                _super.call(this);
                this.form = new Cinema.Admin.Northwind.OrderDetailForm(this.idPrefix);
                ...
                this.form.ProductID.cascadeField = Cinema.Admin.Northwind.ProductRow.Fields.CategoryID;
        ...
        }(Cinema.Admin.Northwind.OrderDetailDialog));
        ...
        var ChangingLookupTextDialog = (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Cinema.Admin.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                this.form.Discount.addValidationRule(this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Cinema.Admin.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Cinema.Admin.Northwind.ProductRow.lookupKey;
            };
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Cinema.Admin.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Cinema.Admin.Northwind.CustomerDialog));
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.CustomerGrid));
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Cinema.Admin.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Cinema.Admin.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Cinema.Admin.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Cinema.Admin.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Cinema.Admin.Northwind.OrderService.baseUrl; };
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.SupplierDialog));
        ...
        var PopulateLinkedDataDialog = (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Cinema.Admin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Cinema.Admin.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Cinema.Admin.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Cinema.Admin.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Cinema.Admin.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Cinema.Admin.Northwind.OrderService.baseUrl; };
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.OrderDialog));
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew) {
                    ...
                    Cinema.Admin.Northwind.CategoryService.Retrieve({
        ...
        }(Cinema.Admin.Northwind.CategoryDialog));
...
(function (Cinema.Admin) {
    ...
    (function (BasicSamples) {
        ...
        }(Cinema.Admin.Northwind.CategoryGrid));
        ...
        var DefaultValuesInNewGrid = (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Cinema.Admin.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Cinema.Admin.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Cinema.Admin.Northwind.OrderDialog();
                        ...
                        var chai = Cinema.Admin.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Cinema.Admin.Northwind.EmployeeRow.getLookup().items
...
(function (Cinema.Admin) {
    ...
    })(Authorization = Cinema.Admin.Authorization || (Cinema.Admin.Authorization = {}));
})(Cinema.Admin || (Cinema.Admin = {}));
var Cinema.Admin;
(function (Cinema.Admin) {
    var Administration;
...
//# sourceMappingURL=Cinema.Admin.Web.js.map