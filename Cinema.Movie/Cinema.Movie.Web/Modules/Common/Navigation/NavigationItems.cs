...
using Movie= Cinema.Movie.Movie;
...
[assembly: NavigationLink(10100, "Movie/Genre", typeof(Movie.Pages.GenreController), icon: "fa-bars")]
[assembly: NavigationLink(10200, "Movie/Movie", typeof(Movie.Pages.MovieController), icon: "fa-film")]
[assembly: NavigationLink(10300, "Movie/Person", typeof(Movie.Pages.PersonController), icon: "fa-users")]
[assembly: NavigationLink(10400, "Movie/Service", typeof(Movie.Pages.ServiceController), icon: "fa-gear")]
[assembly: NavigationLink(10500, "Movie/Tag", typeof(Movie.Pages.TagController), icon: "fa-tags")]
[assembly: NavigationLink(10600, "Movie/Video", typeof(Movie.Pages.VideoController), icon: "fa-video-camera")]