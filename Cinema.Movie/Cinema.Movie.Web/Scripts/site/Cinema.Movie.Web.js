...
(function (Cinema) {
    ...
    (function (Movie_33) {
        var Movie;
        (function (Movie) {
            var CastMoviePersonDialog = (function (_super) {
                __extends(CastMoviePersonDialog, _super);
                function CastMoviePersonDialog() {
                    _super.apply(this, arguments);
                    this.form = new Movie.CastMoviePersonForm(this.idPrefix);
                }
                CastMoviePersonDialog.prototype.getFormKey = function () { return Movie.CastMoviePersonForm.formKey; };
                CastMoviePersonDialog.prototype.getIdProperty = function () { return Movie.CastMoviePersonRow.idProperty; };
                CastMoviePersonDialog.prototype.getLocalTextPrefix = function () { return Movie.CastMoviePersonRow.localTextPrefix; };
                CastMoviePersonDialog.prototype.getService = function () { return Movie.CastMoviePersonService.baseUrl; };
                CastMoviePersonDialog = __decorate([
                    Serenity.Decorators.registerClass(),
                    Serenity.Decorators.responsive()
                ], CastMoviePersonDialog);
                return CastMoviePersonDialog;
            }(Serenity.EntityDialog));
            Movie.CastMoviePersonDialog = CastMoviePersonDialog;
...
(function (Cinema) {
    ...
    (function (Movie_34) {
        var Movie;
        (function (Movie) {
            var CastMoviePersonEditor = (function (_super) {
                __extends(CastMoviePersonEditor, _super);
                function CastMoviePersonEditor(container) {
                    _super.call(this, container);
                }
                CastMoviePersonEditor.prototype.getColumnsKey = function () { return 'Movie.CastMoviePerson'; };
                CastMoviePersonEditor.prototype.getDialogType = function () { return Movie.CastMoviePersonEditorDialog; };
                CastMoviePersonEditor.prototype.getLocalTextPrefix = function () { return Movie.CastMoviePersonRow.localTextPrefix; };
                CastMoviePersonEditor = __decorate([
                    Serenity.Decorators.registerClass()
                ], CastMoviePersonEditor);
                return CastMoviePersonEditor;
            }(Movie_34.Common.GridEditorBase));
            Movie.CastMoviePersonEditor = CastMoviePersonEditor;
...
(function (Cinema) {
    ...
    (function (Movie_35) {
        var Movie;
        (function (Movie) {
            var CastMoviePersonEditorDialog = (function (_super) {
                __extends(CastMoviePersonEditorDialog, _super);
                function CastMoviePersonEditorDialog() {
                    _super.apply(this, arguments);
                    this.form = new Movie.CastMoviePersonForm(this.idPrefix);
                }
                CastMoviePersonEditorDialog.prototype.getFormKey = function () { return Movie.CastMoviePersonForm.formKey; };
                CastMoviePersonEditorDialog.prototype.getLocalTextPrefix = function () { return Movie.CastMoviePersonRow.localTextPrefix; };
                CastMoviePersonEditorDialog = __decorate([
                    Serenity.Decorators.registerClass(),
                    Serenity.Decorators.responsive()
                ], CastMoviePersonEditorDialog);
                return CastMoviePersonEditorDialog;
            }(Movie_35.Common.GridEditorDialog));
            Movie.CastMoviePersonEditorDialog = CastMoviePersonEditorDialog;
...
(function (Cinema) {
    ...
    (function (Movie_36) {
        var Movie;
        (function (Movie) {
            var CastMoviePersonGrid = (function (_super) {
                __extends(CastMoviePersonGrid, _super);
                function CastMoviePersonGrid(container) {
                    _super.call(this, container);
                }
                CastMoviePersonGrid.prototype.getColumnsKey = function () { return 'Movie.CastMoviePerson'; };
                CastMoviePersonGrid.prototype.getDialogType = function () { return Movie.CastMoviePersonDialog; };
                CastMoviePersonGrid.prototype.getIdProperty = function () { return Movie.CastMoviePersonRow.idProperty; };
                CastMoviePersonGrid.prototype.getLocalTextPrefix = function () { return Movie.CastMoviePersonRow.localTextPrefix; };
                CastMoviePersonGrid.prototype.getService = function () { return Movie.CastMoviePersonService.baseUrl; };
                CastMoviePersonGrid = __decorate([
                    Serenity.Decorators.registerClass()
                ], CastMoviePersonGrid);
                return CastMoviePersonGrid;
            }(Serenity.EntityGrid));
            Movie.CastMoviePersonGrid = CastMoviePersonGrid;
...
(function (Cinema) {
    ...
    (function (Movie_41) {
        ...
        (function (Movie) {
            ...
            [['Character', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(CastForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
...
(function (Cinema) {
    ...
    (function (Movie_42) {
        var Movie;
        (function (Movie) {
            var CastMoviePersonForm = (function (_super) {
                __extends(CastMoviePersonForm, _super);
                function CastMoviePersonForm() {
                    _super.apply(this, arguments);
                }
                CastMoviePersonForm.formKey = 'Movie.CastMoviePerson';
                return CastMoviePersonForm;
            }(Serenity.PrefixedContext));
            Movie.CastMoviePersonForm = CastMoviePersonForm;
            [['CastId', function () { return Serenity.IntegerEditor; }], ['MovieId', function () { return Serenity.IntegerEditor; }], ['PersonId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(CastMoviePersonForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
...
(function (Cinema) {
    ...
    (function (Movie_44) {
        var Movie;
        (function (Movie) {
            var CastMoviePersonService;
            (function (CastMoviePersonService) {
                CastMoviePersonService.baseUrl = 'Movie/CastMoviePerson';
                var Methods;
                (function (Methods) {
                })(Methods = CastMoviePersonService.Methods || (CastMoviePersonService.Methods = {}));
                ['Create', 'Update', 'Delete', 'Retrieve', 'List'].forEach(function (x) {
                    CastMoviePersonService[x] = function (r, s, o) { return Q.serviceRequest(CastMoviePersonService.baseUrl + '/' + x, r, s, o); };
                    Methods[x] = CastMoviePersonService.baseUrl + '/' + x;
                });
            })(CastMoviePersonService = Movie.CastMoviePersonService || (Movie.CastMoviePersonService = {}));
    ...
    (function (Movie_45) {
        ...
        (function (Movie) {
            ...
            (function (CastRow) {
                ...
                ['CastId', 'Character'].forEach(function (x) { return Fields[x] = x; });
    ...
    (function (Movie_49) {
        ...
        (function (Movie) {
            ...
            (function (GenreRow) {
                ...
                ['GenreId', 'Name', 'Icon'].forEach(function (x) { return Fields[x] = x; });
...
(function (Cinema) {
    ...
    (function (Movie_54) {
        ...
        (function (Movie) {
            ...
            [['TitleEn', function () { return Serenity.StringEditor; }], ['TitleOther', function () { return Serenity.StringEditor; }], ['Description', function () { return Serenity.StringEditor; }], ['YearStart', function () { return Serenity.IntegerEditor; }], ['YearEnd', function () { return Serenity.IntegerEditor; }], ['ReleaseWorldDate', function () { return Serenity.DateEditor; }], ['ReleaseOtherDate', function () { return Serenity.DateEditor; }], ['ReleaseDvd', function () { return Serenity.DateEditor; }], ['Runtime', function () { return Serenity.IntegerEditor; }], ['CreateDateTime', function () { return Serenity.DateEditor; }], ['UpdateDateTime', function () { return Serenity.DateEditor; }], ['PublishDateTime', function () { return Serenity.DateEditor; }], ['Kind', function () { return Serenity.EnumEditor; }], ['Rating', function () { return Serenity.IntegerEditor; }], ['Mpaa', function () { return Serenity.StringEditor; }], ['PathImage', function () { return Serenity.StringEditor; }], ['PathMiniImage', function () { return Serenity.StringEditor; }], ['Nice', function () { return Serenity.BooleanEditor; }], ['ContSeason', function () { return Serenity.IntegerEditor; }], ['LastEvent', function () { return Serenity.StringEditor; }], ['LastEventPublishDateTime', function () { return Serenity.DateEditor; }], ['Tagline', function () { return Serenity.StringEditor; }], ['Budget', function () { return Serenity.IntegerEditor; }], ['GenreList', function () { return Serenity.LookupEditor; }], ['TagList', function () { return Serenity.LookupEditor; }]].forEach(function (x) { return Object.defineProperty(MovieForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    ...
    (function (Movie_55) {
        ...
        (function (Movie) {
            ...
            (function (MovieGenresRow) {
                ...
                ['MovieGenreId', 'MovieId', 'GenreId', 'MovieTitleEn', 'MovieTitleOther', 'MovieDescription', 'MovieYearStart', 'MovieYearEnd', 'MovieReleaseWorldDate', 'MovieReleaseOtherDate', 'MovieReleaseDvd', 'MovieRuntime', 'MovieCreateDateTime', 'MovieUpdateDateTime', 'MoviePublishDateTime', 'MovieKind', 'MovieRating', 'MovieMpaa', 'MoviePathImage', 'MoviePathMiniImage', 'MovieNice', 'MovieContSeason', 'MovieLastEvent', 'MovieLastEventPublishDateTime', 'MovieTagline', 'MovieBudget', 'GenreName'].forEach(function (x) { return Fields[x] = x; });
...
(function (Cinema) {
    ...
    (function (Movie_60) {
        ...
        (function (Movie) {
            ...
            [['FirstNameEn', function () { return Serenity.StringEditor; }], ['MiddleNameEn', function () { return Serenity.StringEditor; }], ['LastNameEn', function () { return Serenity.StringEditor; }], ['FirstNameOther', function () { return Serenity.StringEditor; }], ['MiddleNameOther', function () { return Serenity.StringEditor; }], ['LastNameOther', function () { return Serenity.StringEditor; }], ['BirthDate', function () { return Serenity.DateEditor; }], ['DeathDate', function () { return Serenity.DateEditor; }], ['BirthPlace', function () { return Serenity.StringEditor; }], ['Gender', function () { return Serenity.EnumEditor; }], ['About', function () { return Serenity.StringEditor; }], ['PathImage', function () { return Serenity.StringEditor; }]].forEach(function (x) { return Object.defineProperty(PersonForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    ...
    (function (Movie_61) {
        ...
        (function (Movie) {
            ...
            (function (PersonRow) {
                ...
                PersonRow.nameProperty = 'FirstNameOther';
                PersonRow.localTextPrefix = 'Movie.Person';
                var Fields;
                (function (Fields) {
                })(Fields = PersonRow.Fields || (PersonRow.Fields = {}));
                ['PersonId', 'FirstNameEn', 'MiddleNameEn', 'LastNameEn', 'FirstNameOther', 'MiddleNameOther', 'LastNameOther', 'BirthDate', 'DeathDate', 'BirthPlace', 'Gender', 'About', 'PathImage'].forEach(function (x) { return Fields[x] = x; });
...
(function (Cinema) {
    ...
    (function (Movie_67) {
        ...
        (function (Movie) {
            ...
            [['Rating', function () { return Serenity.IntegerEditor; }], ['MovieId', function () { return Serenity.StringEditor; }], ['ServiceId', function () { return Serenity.IntegerEditor; }]].forEach(function (x) { return Object.defineProperty(ServiceRatingForm.prototype, x[0], { get: function () { return this.w(x[0], x[1]()); }, enumerable: true, configurable: true }); });
    ...
    (function (Movie_68) {
        ...
        (function (Movie) {
            ...
            (function (ServiceRatingRow) {
                ...
                ['ServiceRatingId', 'Rating', 'MovieId', 'ServiceId', 'MovieTitleEn', 'MovieTitleOther', 'MovieDescription', 'MovieYearStart', 'MovieYearEnd', 'MovieReleaseWorldDate', 'MovieReleaseOtherDate', 'MovieReleaseDvd', 'MovieRuntime', 'MovieCreateDateTime', 'MovieUpdateDateTime', 'MoviePublishDateTime', 'MovieKind', 'MovieRating', 'MovieMpaa', 'MoviePathImage', 'MoviePathMiniImage', 'MovieNice', 'MovieContSeason', 'MovieLastEvent', 'MovieLastEventPublishDateTime', 'MovieTagline', 'MovieBudget', 'ServiceName', 'ServiceApi', 'ServiceMaxRating'].forEach(function (x) { return Fields[x] = x; });
    ...
    (function (Movie_70) {
        ...
        (function (Movie) {
            ...
            (function (ServiceRow) {
                ...
                ['ServiceId', 'Name', 'Api', 'Active', 'IntervalRequest', 'LastEvent', 'LastEventPublishDateTime', 'MaxRating'].forEach(function (x) { return Fields[x] = x; });
