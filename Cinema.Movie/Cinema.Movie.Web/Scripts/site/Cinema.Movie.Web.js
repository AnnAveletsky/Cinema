    ...
    (function (Movie_44) {
        ...
        (function (Movie) {
            ...
            (function (CastRow) {
                ...
                ['CastId', 'CharacterEn', 'CharacterOther', 'MovieId', 'PersonId', 'MovieTitleOriginal', 'MovieTitleTranslation', 'MovieYearStart', 'MovieYearEnd', 'MoviePathImage', 'PersonName', 'PersonFullName', 'PersonNameOther', 'PersonFullNameOther', 'PersonUrl', 'PersonBirthDate', 'PersonDeathDate', 'PersonBirthPlace', 'PersonGender', 'PersonPathImage'].forEach(function (x) { return Fields[x] = x; });
    ...
    (function (Movie_76) {
        ...
        (function (Movie) {
            ...
            (function (ServiceRow) {
                ...
                ['ServiceId', 'Name', 'Api', 'Active', 'IntervalRequest', 'MaxRating', 'PathListPath', 'PathList'].forEach(function (x) { return Fields[x] = x; });
