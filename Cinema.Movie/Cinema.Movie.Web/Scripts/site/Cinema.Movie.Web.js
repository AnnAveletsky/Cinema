...
(function (Cinema) {
    ...
    (function (Movie_38) {
        ...
        (function (Movie) {
            var CastMovieRow;
            (function (CastMovieRow) {
                CastMovieRow.idProperty = 'CastMovieId';
                CastMovieRow.localTextPrefix = 'Movie.CastMovie';
                var Fields;
                (function (Fields) {
                })(Fields = CastMovieRow.Fields || (CastMovieRow.Fields = {}));
            ...
            })(CastMovieRow = Movie.CastMovieRow || (Movie.CastMovieRow = {}));
...
(function (Cinema) {
    ...
    (function (Movie_39) {
        ...
        (function (Movie) {
            var CastPersonRow;
            (function (CastPersonRow) {
                CastPersonRow.idProperty = 'CastPersonId';
                CastPersonRow.localTextPrefix = 'Movie.CastPerson';
                var Fields;
                (function (Fields) {
                })(Fields = CastPersonRow.Fields || (CastPersonRow.Fields = {}));
                ['CastPersonId', 'CastId', 'PersonId', 'CastCharacter', 'PersonFirstNameEn', 'PersonMiddleNameEn', 'PersonLastNameEn', 'PersonFirstNameOther', 'PersonMiddleNameOther', 'PersonLastNameOther', 'PersonBirthDate', 'PersonDeathDate', 'PersonBirthPlace', 'PersonGender', 'PersonAbout', 'PersonPathImage'].forEach(function (x) { return Fields[x] = x; });
            })(CastPersonRow = Movie.CastPersonRow || (Movie.CastPersonRow = {}));
