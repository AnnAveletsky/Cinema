...
namespace Cinema.Movie.Entities
{
    ...
    public sealed class CastRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Character En"), Size(100), NotNull, QuickSearch]
        ...
        [DisplayName("Character Other"), Size(100), NotNull]
        ...
        [DisplayName("Person"), NotNull, ForeignKey("[dbo].[Person]", "PersonId"), LeftJoin("jPerson"), TextualField("PersonName")]
